...
def get_snow_report():
    ...
    trail_list = {
        ...
        'Raspberry': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[4]/td[2]/text()')[0],
        'Soft Landings': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[5]/td[2]/text()')[0],
        'Strawberry': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[6]/td[2]/text()')[0],
        'Valley View': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[7]/td[2]/text()')[0],
        'Cut Throat': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[8]/td[2]/text()')[0],
        'E-Z Pass': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[9]/td[2]/text()')[0],
        'East Pass': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[10]/td[2]/text()')[0],
        'Halfway': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[11]/td[2]/text()')[0],
        'Northwest Pass': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[12]/td[2]/text()')[0],
        'Timber Gulch': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[13]/td[2]/text()')[0],
        'Timber Trail': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[14]/td[2]/text()')[0],
        'Alpine': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[15]/td[2]/text()')[0],
        'Big Thunder': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[16]/td[2]/text()')[0],
        'Broadway': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[17]/td[2]/text()')[0],
        'Lodge': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[18]/td[2]/text()')[0],
        'Mohawk': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[19]/td[2]/text()')[0],
        'Shelter': tree.xpath('//*[@id="body-copy"]/table[2]/tr[2]/td/table[1]/tr[20]/td[2]/text()')[0]
    }
